        ...
        <div class="flex-section__60 pr-10">
            <div class="flex-section">
                ...
                <div class="flex-section__inner-left pl-10">
                    <form name="registrationform" id="registrationform" action="<?php echo wp_registration_url(); ?>" method="post">
                        ...
                        <p class="login-username">
                            ...
                            <input type="email" name="user_email" id="user_email"></label>
                        </p>
                        <p class="login-password">
                            <label>Password</label>
                            <input type="password" name="user_password" id="user_password"></label>
                        </p>
                        <input type="hidden" name="redirect_to" value="<?php echo site_url('/login'); ?>">
                        <input type="submit" name="wp-submit" id="wp-submit" class="button" value="Register">
                    </form>
                </div>
            </div>
        </div>
